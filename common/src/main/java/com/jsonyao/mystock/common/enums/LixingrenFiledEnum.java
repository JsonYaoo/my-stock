...
public enum LixingrenFiledEnum {
    ...
    TOTAL_SHARE_CAPITAL("total_share_capital", "总股本", LixingrenTableEnum.SYNC_FINANCE_INDEX.getValue(), "totalShareCapital"),
    DIVIDEND_RATIO("dividend_ratio", "分红率", LixingrenTableEnum.SYNC_FINANCE_INDEX.getValue(), "dividendRatio"),
    PCOMPANY_HOLDERS_WEIGHTED_ROE("pcompany_holders_weighted_roe", "归属于母公司普通股股东加权ROE", LixingrenTableEnum.SYNC_FINANCE_INDEX.getValue(), "phWeightedRoe"),
    NET_PROFIT_RATIO("net_profit_ratio", "净利润率", LixingrenTableEnum.SYNC_FINANCE_INDEX.getValue(), "netProfitRatio"),
    GROSS_MARGIN_GM("gross_Margin_gm", "毛利率GM", LixingrenTableEnum.SYNC_FINANCE_INDEX.getValue(), "grossMarginGm"),
    LEVERAGE("leverage", "杠杆倍数", LixingrenTableEnum.SYNC_FINANCE_INDEX.getValue(), "leverage"),
    ASSETS_LIABILITIES_RATIO("assets_liabilities_ratio", "资产负债率", LixingrenTableEnum.SYNC_FINANCE_INDEX.getValue(), "assetsLiaRatio"),
    INTEREST_BEARING_DEBT_RATIO("interest_bearing_debt_ratio", "有息负债率", LixingrenTableEnum.SYNC_FINANCE_INDEX.getValue(), "ibDebtRatio"),
    CURRENT_RATIO("current_ratio", "流动比率", LixingrenTableEnum.SYNC_FINANCE_INDEX.getValue(), "currentRatio"),
    QUICK_RATIO("quick_ratio", "速动比率", LixingrenTableEnum.SYNC_FINANCE_INDEX.getValue(), "quickRatio"),
    SALES_COSTS_RATIO("sales_costs_ratio", "销售费用率", LixingrenTableEnum.SYNC_FINANCE_INDEX.getValue(), "salesCostsRatio"),
    MANAGEMENT_COSTS_RATIO("management_costs_ratio", "管理费用率", LixingrenTableEnum.SYNC_FINANCE_INDEX.getValue(), "magCostsRatio"),
    FINANCIAL_COSTS_RATIO("financial_costs_ratio", "财务费用率", LixingrenTableEnum.SYNC_FINANCE_INDEX.getValue(), "finCostsRatio"),
    RD_COSTS_RATIO("rd_costs_ratio", "研发费用率", LixingrenTableEnum.SYNC_FINANCE_INDEX.getValue(), "rdCostsRatio"),
    ASSET_TURNOVER_RATIO("asset_turnover_ratio", "资产周转率", LixingrenTableEnum.SYNC_FINANCE_INDEX.getValue(), "assetTurnoverRatio"),
    INVENTORY_TURNOVER_DAYS("inventory_turnover_days", "存货周转天数", LixingrenTableEnum.SYNC_FINANCE_INDEX.getValue(), "inventoryTd"),
    ACCOUNTS_PAYABLE_TURNOVER_DAYS("accounts_payable_turnover_days", "应付账款周转天数", LixingrenTableEnum.SYNC_FINANCE_INDEX.getValue(), "accountsPayableTd"),
    ACCOUNTS_RECEIVABLE_TURNOVER_DAYS("accounts_receivable_turnover_days", "应收账款周转天数", LixingrenTableEnum.SYNC_FINANCE_INDEX.getValue(), "accountsReceivableTd"),
    PREPAYMENTS_TURNOVER_DAYS("prepayments_turnover_days", "预付账款周转天数", LixingrenTableEnum.SYNC_FINANCE_INDEX.getValue(), "prepaymentsTd"),
    ADVANCE_PAYMENT_TURNOVER_DAYS("advance_payment_turnover_days", "预收账款周转天数", LixingrenTableEnum.SYNC_FINANCE_INDEX.getValue(), "advancePaymentTd"),;
